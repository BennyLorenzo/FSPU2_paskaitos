...
zaidejai_pagal_pozicija(komanda)
zaidejai_pagal_pozicija(komanda,'PF','SF','C')
...
autonr_listas = ["EEDE145", "AB1234", "EA1245", "XSWQ12", "ABE111", "VVO456", "EA1000", "BAD555"]
print(check_autonr_c(autonr_listas))
